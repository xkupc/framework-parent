...
/**
 * @author xk
 * @createTime 2018/1/9 0009 下午 4:45
 * @description
 */
@Component
public class RoutingTestPublisher extends PublisherConfirmHandler{
    private static Logger logger = LoggerFactory.getLogger(RoutingTestPublisher.class);
